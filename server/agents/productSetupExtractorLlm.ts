...
const productSetupExtractionSystemInstruction = [
  ...
  'For term/maturity: extract phrases like "term is 3 years" and "maturity is 3 years after IPO" into duration_months, and exact maturity dates into maturity_date only when the date is explicitly stated.',
